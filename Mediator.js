// from http://thejacklawson.com/Mediator.js/
(function (global, factory) {
    'use strict';

    if (typeof exports !== 'undefined') {// Node/CommonJS   
    ...
    function Channel(namespace, parent) {//也就是Topic
            ...
            for (x, y; x < y; x++) {
                if (!this.stopped) {
                    ...
                    if (subscriber.options !== undefined && typeof subscriber.options.predicate === "function") {
                        if (subscriber.options.predicate.apply(subscriber.context, data)) {//predicate是什么
    ...
    Mediator.prototype = {
        ...
        getChannel: function (namespace) {
            var channel = this._channels,
                namespaceHierarchy = namespace.split(':'),//这是一棵树
                x = 0,
